...
- [`data/data1_raw.xls`](data/data1_raw.xls) — исходные данные по бракам в России: 14 строк, есть пропуски, лишние данные о статистике за квартал;
- [`data/data2_raw.xls`](data/data2_raw.xls) — исходные данные по разводам в России: 14 строк, есть пропуски, лишние данные о статистике за квартал;
- [`data/data(7).xls`](data/data(7).xls) — файл для работы таблицы браков с pandas;
- [`data/data(6).xls`](data/data(6).xls) — файл для работы таблицы разводов с pandas;
- [`data/data_clean.xls`](data/data_clean.xls) — очищенные данные по бракам и разводам в России: 25 строк, все пропуски заполнены. Форматы приведены к единому стандарту, таблицы соединены;
...
![Среднегодовая динамика браков](1_mariage_dynamics.png)
...
![Количество браков 2020](02_number_of_mariages.png)
...
![Динамика браков в регионах](03_marriage_dynamics_2020.png)
...
![Количество разводов 2020](04_number_of_divorces_2020.png)
